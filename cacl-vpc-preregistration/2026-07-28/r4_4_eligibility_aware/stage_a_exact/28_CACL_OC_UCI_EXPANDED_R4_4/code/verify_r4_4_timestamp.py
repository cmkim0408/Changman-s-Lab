#!/usr/bin/env python3
"""Revalidate the public R4.4 timestamp and every locked artifact."""
...
def main() -> None:
    output = RECEIPTS / "R4_4_EXTERNAL_TIMESTAMP_VERIFICATION.json"
    if output.exists():
    ...
    receipt = {
        "schema": "cacl-oc-r4.4-timestamp-verification-v1",
        "status": "R4_4_TARGET_REVEAL_AUTHORIZED",
