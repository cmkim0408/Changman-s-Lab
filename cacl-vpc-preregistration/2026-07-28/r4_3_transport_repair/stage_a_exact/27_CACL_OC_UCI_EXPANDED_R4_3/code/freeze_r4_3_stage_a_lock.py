#!/usr/bin/env python3
"""Hash-lock R4.3 dataset registration before new-data access."""
...
def main() -> None:
    output = RECEIPTS / "R4_3_STAGE_A_LOCAL_LOCK.json"
    if output.exists():
    ...
    payload = {
        "schema": "cacl-oc-r4.3-stage-a-local-lock-v1",
        "status": "R4_3_STAGE_A_LOCKED_BEFORE_NEW_DATA_ACCESS",
