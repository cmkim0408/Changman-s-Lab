#!/usr/bin/env python3
"""Revalidate the public R4.5 timestamp and every locked artifact."""
...
def main() -> None:
    output = RECEIPTS / "R4_5_EXTERNAL_TIMESTAMP_VERIFICATION.json"
    if output.exists():
    ...
    receipt = {
        "schema": "cacl-oc-r4.5-timestamp-verification-v1",
        "status": "R4_5_TARGET_REVEAL_AUTHORIZED",
